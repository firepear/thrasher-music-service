...
![Desktop client](https://github.com/firepear/thrasher-music-tool/blob/main/docs/dt.jpg)

There is a compact, more finger-friendly mobile UI at
`REDIR-HOST:LISTEN-PORT/m.html`. This is the interface that can be
presented as a PWA

![Mobile client](https://github.com/firepear/thrasher-music-tool/blob/main/docs/m.jpg)
